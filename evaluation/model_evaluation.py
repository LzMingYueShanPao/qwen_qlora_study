...
def main():
    ...
    with open('/root/autodl-tmp/jiangxia/finetune/qwen_qlora/data/text_matching_data_test.jsonl',
                'r', encoding='utf-8') as read_file, \
          open('/root/autodl-tmp/jiangxia/finetune/qwen_qlora/data/text_matching_data_test_result.csv',
